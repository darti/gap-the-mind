declare module "tiptap" {
  ...
  export class Editor {
     ...
     */
    setContent(content?: string | object, emitUpdate?: boolean): any
     ...
     */
    setOptions(options: EditorOptions): any
    ...
    on(event: string, callbackFn: (params: any) => void): any

    off(event: string, callbackFn: (params: any) => void): any
